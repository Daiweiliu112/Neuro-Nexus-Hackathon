...
urlpatterns = [
    ...
    path('cli/<str:room_name>/<int:pk>/<int:client_id>/',views.clinician_test,name='clinician_test'),
    path('client/<str:room_name>/<int:pk>/',views.client_test,name='client_test'),
